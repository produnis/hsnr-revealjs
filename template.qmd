...
#bibliography: my_literature.bib
format:
...
## Quarto und Revealjs {background-image="_extensions/produnis/hsnr/HSNRtheme/KreisschwungKrefeld.png" background-position="left" background-size="21%"}
...
![](_extensions/produnis/hsnr/HSNRtheme/Hochschule_niederrhein.png){.absolute bottom=0 right=0 width=300}
:::
...
![](_extensions/produnis/hsnr/HSNRtheme/beforeyoustartitsnoteasy.jpg){width=300}
:::
...
:::{.tc}
![](_extensions/produnis/hsnr/HSNRtheme/beforeyoustartitsnoteasy.jpg){width="350"}
...
![](_extensions/produnis/hsnr/HSNRtheme/letztefolie1.png)

![](_extensions/produnis/hsnr/HSNRtheme/letztefolie2.png)
...
<!-- ------ Letzte Folie #1 ----------------------------------->
<!-- ======================================================  -->
## {background-image="_extensions/produnis/hsnr/HSNRtheme/KrefeldCampus_night.jpg" background-size="120%"}
...
::: {.column width="18%"}
<center>
![](_extensions/produnis/hsnr/HSNRtheme/HSNLogo_quadrat2.jpg){width="200px"}
</center>
:::
::: {.column width="80%"}
...
:::{.absolute top=-90 .tc}
![](_extensions/produnis/hsnr/HSNRtheme/GebauedeH_Rand.webp){width=80%}
:::
...
<!-- ------ Literatur -------------------------------------->
## {.smaller background-image="_extensions/produnis/hsnr/HSNRtheme/bibliothek.jpg" background-size="120%"}
